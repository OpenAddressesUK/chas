...
class TurbotDockerRunner
  ...
  def create_container
    ...
    container_params = {
      ...
      'Env' => ["RUN_TYPE=#{@run_type}", "MORPH_URL=#{ENV['MORPH_URL']}", "LAST_RUN_AT='#{@last_run_at}'", "IRON_MQ_TOKEN=#{ENV['IRON_MQ_TOKEN']}", "IRON_MQ_PROJECT_ID=#{ENV['IRON_MQ_PROJECT_ID']}"].concat(env_array)
    }
